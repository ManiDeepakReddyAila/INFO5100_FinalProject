...
//        }
    ...
    public Bill(String name, String medicines, String test_name, String healthcamp_name){
        initComponents();
...
//        jLabel1.setText(jLabel1.getText() + name);
        ...
        for(String s: Arrays.asList(medicines.split("<>"))){
            ...
            try {
                ...
                while (rs.next()) {
                    medicine_price = rs.getInt("price");
                }
            ...
            row[0] = s.split(" --- ")[0];
            row[1] = s.split(" --- ")[1];
            row[2] = medicine_price;
            row[3] = Integer.parseInt(s.split(" --- ")[1]) * medicine_price;
            model.addRow(row);
            sum += Integer.parseInt(s.split(" --- ")[1]) * medicine_price;
        }
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fp?zeroDateTimeBehavior=CONVERT_TO_NULL", "root", "Deepak@1999");
            Statement myStatement = con.createStatement();
            String query1 = "select patient_name from bill where patient_name = '" + name + "'";
            ResultSet rs = myStatement.executeQuery(query1);
            if(!rs.next()){
                String query = "Insert into `bill`" + "values('" + name + "','" + healthcamp_name + "','" + sum + "')";
                myStatement.executeUpdate(query);
                JOptionPane.showMessageDialog(this, "Bill added to DB!!..");
            }
    ...
    private void initComponents() {
        ...
        jTable1.setBackground(new java.awt.Color(223, 227, 235));
