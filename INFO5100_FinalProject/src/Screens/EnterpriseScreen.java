...
public class EnterpriseScreen extends javax.swing.JPanel {
    ...
    public EnterpriseScreen(JPanel rightPanel) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                cmbCountry2.addItem(rs.getString("network_name"));
            }
            con.close();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fp?zeroDateTimeBehavior=CONVERT_TO_NULL", "root", "Deepak@1999");
            Statement myStatement = con.createStatement();
            String query = "Insert into `enterprise` " + "values('" + Name + "','" + Country + "')";
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fp?zeroDateTimeBehavior=CONVERT_TO_NULL", "root", "Deepak@1999");
            Statement myStatement = con.createStatement();
            String query = "select * from enterprise where network_name ='" + Country + "'";
            ResultSet rs = myStatement.executeQuery(query);
            //System.out.println("Inserted data");

            while (rs.next()) {
                String EnterpriseName = rs.getString("enterprise_name");
                String Country1 = rs.getString("network_name");
