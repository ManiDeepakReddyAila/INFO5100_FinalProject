...
public class OrgScreen extends javax.swing.JPanel {
    ...
    public OrgScreen(JPanel rightPanel) {
        ...
        try {
            ...
            while (rs.next()) {
                cmbCountry.addItem(rs.getString("network_name"));
            }
    ...
    private void initComponents() {
        ...
        tblManageOrg.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Country", "Enterprise", "Organisation Type", "Organisation Name"
            }
        ));
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fp?zeroDateTimeBehavior=CONVERT_TO_NULL", "root", "Deepak@1999");
            Statement myStatement = con.createStatement();
            String query_insert = "Insert into `organization` " + "values('" + OrgName + "','" + Orgtype + "','" + EnterpriseSel + "','" + CountrySel + "')";
    ...
    private void cmbCountryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbCountryActionPerformed
        ...
        try {
            ...
            String enterquery = "Select * from enterprise where network_name='" + CountrySelect + "'";
            ResultSet rs1 = myStatement.executeQuery(enterquery);
            while (rs1.next()) {
                cmbEnterprise.addItem(rs1.getString("enterprise_name"));
            }
            con.close();
        } //System.out.println("Inserted data");
        catch (Exception E) {
