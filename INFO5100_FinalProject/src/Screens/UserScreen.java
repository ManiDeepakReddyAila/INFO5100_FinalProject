...
public class UserScreen extends javax.swing.JPanel {
    ...
    public UserScreen(JPanel rightPanel) {
        ...
        try {
            ...
            String query1 = "select distinct network_name from network";
            ResultSet rs1 = myStatement.executeQuery(query1);
            cmbNetwork.removeAllItems();
            while (rs1.next()) {
                cmbNetwork.addItem(rs1.getString("network_name"));
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        try {
            ...
            String Check = "Select distinct username from users";
            ...
            if (!txtUserName.getText().isEmpty()) {
                String query = "Insert into `users`" + "values('" + Name + "','" + UserName + "','" + Password + "','" + Country + "','" + EmailId + "','" + Enterprise + "','" + Organization + "','" + Contact + "')";
    ...
    private void cmbNetworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbNetworkActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fp?zeroDateTimeBehavior=CONVERT_TO_NULL", "root", "Deepak@1999");
            Statement myStatement = con.createStatement();
            String query1 = "select distinct enterprise from organization where network ='" + CountrySelected + "'";
            ResultSet rs1 = myStatement.executeQuery(query1);
            cmbEnterprise.removeAllItems();
            //cmbOrg.removeAllItems();
            while (rs1.next()) {
                cmbEnterprise.addItem(rs1.getString("enterprise"));
    ...
    private void cmbEnterpriseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbEnterpriseActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fp?zeroDateTimeBehavior=CONVERT_TO_NULL", "root", "Deepak@1999");
            Statement myStatement = con.createStatement();
            String query2 = "select name from organization where enterprise ='" + EnterpriseSelected + "' and network ='" + CountrySelected + "'";
            ResultSet rs1 = myStatement.executeQuery(query2);
            cmbOrg.removeAllItems();
            //cmbOrg.removeAllItems();
            while (rs1.next()) {
                cmbOrg.addItem(rs1.getString("name"));
